...
| **infrastructure** | `renderer/features/*/infrastructure/` | リポジトリ実装（IPC クライアント経由） | domain, application, shared |
...
│   └── index.ts             # メインプロセスエントリ
├── renderer/                # レンダラープロセス
│   ├── features/            # 機能モジュール（Clean Architecture 4層）
│   │   └── {feature-name}/
│   │       ├── application/     # UseCase, Service
│   │       ├── infrastructure/  # IPC クライアント（Repository Impl）
