...
export type RebaseInteractiveMainUseCase = FunctionUseCase<
  InteractiveRebaseOptions,
...
export const RebaseAbortMainUseCaseToken =
  createToken<RebaseAbortMainUseCase>('RebaseAbortMainUseCase')

export type RebaseContinueMainUseCase = FunctionUseCase<string, Promise<RebaseResult>>
export const RebaseContinueMainUseCaseToken =
  createToken<RebaseContinueMainUseCase>('RebaseContinueMainUseCase')

export type GetRebaseCommitsMainUseCase = FunctionUseCase<
  { worktreePath: string; onto: string },
  Promise<RebaseStep[]>
>
export const GetRebaseCommitsMainUseCaseToken =
  createToken<GetRebaseCommitsMainUseCase>('GetRebaseCommitsMainUseCase')

// --- スタッシュ ---
export type StashSaveMainUseCase = ConsumerUseCase<StashSaveOptions>
export const StashSaveMainUseCaseToken =
  createToken<StashSaveMainUseCase>('StashSaveMainUseCase')

export type StashListMainUseCase = FunctionUseCase<string, Promise<StashEntry[]>>
export const StashListMainUseCaseToken =
  createToken<StashListMainUseCase>('StashListMainUseCase')

export type StashPopMainUseCase = ConsumerUseCase<{ worktreePath: string; index: number }>
export const StashPopMainUseCaseToken =
  createToken<StashPopMainUseCase>('StashPopMainUseCase')

export type StashApplyMainUseCase = ConsumerUseCase<{ worktreePath: string; index: number }>
export const StashApplyMainUseCaseToken =
  createToken<StashApplyMainUseCase>('StashApplyMainUseCase')

export type StashDropMainUseCase = ConsumerUseCase<{ worktreePath: string; index: number }>
export const StashDropMainUseCaseToken =
  createToken<StashDropMainUseCase>('StashDropMainUseCase')

export type StashClearMainUseCase = ConsumerUseCase<string>
export const StashClearMainUseCaseToken =
  createToken<StashClearMainUseCase>('StashClearMainUseCase')

// --- チェリーピック ---
export type CherryPickMainUseCase = FunctionUseCase<CherryPickOptions, Promise<CherryPickResult>>
export const CherryPickMainUseCaseToken =
  createToken<CherryPickMainUseCase>('CherryPickMainUseCase')

export type CherryPickAbortMainUseCase = ConsumerUseCase<string>
export const CherryPickAbortMainUseCaseToken =
  createToken<CherryPickAbortMainUseCase>('CherryPickAbortMainUseCase')
...
export const TagCreateMainUseCaseToken =
  createToken<TagCreateMainUseCase>('TagCreateMainUseCase')

export type TagDeleteMainUseCase = ConsumerUseCase<{ worktreePath: string; tagName: string }>
export const TagDeleteMainUseCaseToken =
  createToken<TagDeleteMainUseCase>('TagDeleteMainUseCase')
