...
export const advancedGitOperationsMainConfig: VContainerConfig = {
  register(container) {
    ...
    container
      ...
      .registerSingleton(MergeAbortMainUseCaseToken, MergeAbortUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(MergeStatusMainUseCaseToken, MergeStatusUseCase, [GitAdvancedRepositoryToken])
      // コンフリクト解決
      .registerSingleton(ConflictListMainUseCaseToken, ConflictListUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(ConflictFileContentMainUseCaseToken, ConflictFileContentUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(ConflictResolveMainUseCaseToken, ConflictResolveUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(ConflictResolveAllMainUseCaseToken, ConflictResolveAllUseCase, [GitAdvancedRepositoryToken])
      ...
      .registerSingleton(RebaseInteractiveMainUseCaseToken, RebaseInteractiveUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(RebaseAbortMainUseCaseToken, RebaseAbortUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(RebaseContinueMainUseCaseToken, RebaseContinueUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(GetRebaseCommitsMainUseCaseToken, GetRebaseCommitsUseCase, [GitAdvancedRepositoryToken])
      // スタッシュ
      .registerSingleton(StashSaveMainUseCaseToken, StashSaveUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(StashListMainUseCaseToken, StashListUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(StashPopMainUseCaseToken, StashPopUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(StashApplyMainUseCaseToken, StashApplyUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(StashDropMainUseCaseToken, StashDropUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(StashClearMainUseCaseToken, StashClearUseCase, [GitAdvancedRepositoryToken])
      // チェ��ーピック
      .registerSingleton(CherryPickMainUseCaseToken, CherryPickUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(CherryPickAbortMainUseCaseToken, CherryPickAbortUseCase, [GitAdvancedRepositoryToken])
      // タグ
      .registerSingleton(TagListMainUseCaseToken, TagListUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(TagCreateMainUseCaseToken, TagCreateUseCase, [GitAdvancedRepositoryToken])
      .registerSingleton(TagDeleteMainUseCaseToken, TagDeleteUseCase, [GitAdvancedRepositoryToken])
  },
