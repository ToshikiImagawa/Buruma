import type { OpenInEditorUseCase } from '@/features/application-foundation/di-tokens'
import type { WorktreeInfo } from '@domain'
import { useResolve } from '@lib/di'
import { cn } from '@lib/utils'
import { Circle, Code, GitBranch, Trash2 } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { ContextMenu, ContextMenuContent, ContextMenuItem, ContextMenuTrigger } from '@/components/ui/context-menu'
import { OpenInEditorUseCaseToken } from '@/features/application-foundation/di-tokens'
