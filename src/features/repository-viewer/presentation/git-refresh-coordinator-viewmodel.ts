import type { ObserveAdvancedOperationCompletedUseCase } from '@/features/advanced-git-operations/di-tokens'
import type { ObserveOperationCompletedUseCase as ObserveBasicOperationCompletedUseCase } from '@/features/basic-git-operations/di-tokens'
