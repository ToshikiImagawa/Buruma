...
export const advancedGitOperationsConfig: VContainerConfig = {
  register(container) {
    ...
    container
      ...
      .registerSingleton(RebaseInteractiveRendererUseCaseToken, RebaseInteractiveUseCase, REPO_AND_SERVICE)
      ...
      .registerSingleton(CherryPickAbortRendererUseCaseToken, CherryPickAbortUseCase, REPO_AND_SERVICE)
      // コンフリクト解決
      .registerSingleton(ConflictListRendererUseCaseToken, ConflictListUseCase, REPO_AND_SERVICE)
      .registerSingleton(ConflictFileContentRendererUseCaseToken, ConflictFileContentUseCase, REPO_AND_SERVICE)
      .registerSingleton(ConflictResolveRendererUseCaseToken, ConflictResolveUseCase, REPO_AND_SERVICE)
      .registerSingleton(ConflictResolveAllRendererUseCaseToken, ConflictResolveAllUseCase, REPO_AND_SERVICE)
      .registerSingleton(ConflictMarkResolvedRendererUseCaseToken, ConflictMarkResolvedUseCase, REPO_AND_SERVICE)
      // タグ
    ...
    container
      ...
      .registerSingleton(GetAdvancedLastErrorUseCaseToken, GetLastErrorUseCase, [AdvancedOperationsServiceToken])
